...
const games: GameEntry[] = [
  ...
  { to: '/games/plinko', label: 'Plinko', icon: CircleSlash },
  { to: '/games/towers', label: 'Towers', icon: TowerControl },
  { to: '/games/roulette', label: 'Roulette', icon: Disc },
  { to: '/games/coinflip', label: 'Coinflip', icon: Coins },
  { to: '/games/case-battle', label: 'Case Battle', icon: Swords },
